...
import { setDarkMode, setEngravingDescriptions } from "../actions";
            ...
            <ul className="col-md-6 list-inline">
                <li className="list-group-item d-sm-flex w-100">
                    <div className="w-50 custom-spacer">
                        <label className="form-check-label" for="flexSwitchCheckDefault">Dark mode {darkModeRedux ? "On" : "Off"}</label>
                    </div>
                    <div className="form-check form-switch w-50 d-sm-flex justify-content-center custom-input-container">
                        <input onClick={() => dispatch(setDarkMode(!darkModeRedux))} checked={darkModeRedux} className="form-check-input d-sm-inline-block" type="checkbox" role="switch" id="flexSwitchCheckChecked" />
                    </div>
                </li>
